...
// Validate ../../../app/api/submit-to-sheet/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/submit-to-sheet">> = Specific
  const handler = {} as typeof import("../../../app/api/submit-to-sheet/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
